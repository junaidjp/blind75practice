...
class ReverseLinkedList {
    ...
    public static void main(String[] args) {
        ...
        PrintList.printListWithForwardArrow(reverseThisList(obj1.head));
        //PrintList.printListWithForwardArrow(obj1.head);
    ...
    private static LinkedListNode reverseThisList(LinkedListNode head) {
...
/**
          ...
          curr.next = prev; // reverse the current nodes pointers
